  ...
  return (
    <View style={styles.deadline}>
      <View row center marginH-20>
        <Image source={AppImages.DEADLINE} width={24} height={24} marginR-10 />
      ...
      <View row marginH-15>
        <View backgroundColor="#00A1FC" style={styles.smallView}>
          <Image source={AppImages.UPDATE} width={24} height={24} marginR-5 />
          <Text style={styles.text2}>Edit Trip</Text>
        </View>

        <View backgroundColor="#FF6565" style={styles.smallView}>
          <Image source={AppImages.CANCEL} width={18} height={18} marginR-5 />
      ...
      {mark && (
        <View marginH-20 marginT-10>
          ...
          />
          <Checkbox label="peter" labelStyle={styles.text2} color="white"  style={{borderRadius:2}}
            containerStyle={{marginBottom: 20}}/>
        </View>
      )}
    </View>
